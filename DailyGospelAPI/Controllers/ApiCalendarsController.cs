...
using DailyGospelAPI.Models;

namespace DailyGospelAPI.Controllers
{
    public class ApiCalendarsController : ApiController
    {
        private ApplicationDbContext db = new ApplicationDbContext();

        // GET: api/ApiCalendars
        public IQueryable<Calendar> GetCalendars()
        {
            return db.Calendars;
        }

        // GET: api/ApiCalendars/5
